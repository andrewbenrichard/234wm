                ...
                <div class="row footer-widget-wrapper">
                    <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                        ...
                        <ul class="footer-widget__list">
                            <li>Naf Conference center Jahi Abuja</li>
                            <li><a href="mailto:info@234wm.com.ng" class="hover-style-link">info@234wm.com.ng</a></li>
                            <li><a href="tel:+23481600000" class="hover-style-link text-black font-weight--bold">+23481600000</a></li>
                            <li><a href="https://234wm.com.ng/" class="hover-style-link text-color-primary">www.234wm.com.ng</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                        <h6 class="footer-widget__title mb-20">Services</h6>
                        <ul class="footer-widget__list">
                            <li><a href="/services" class="hover-style-link">Residential Pickup</a></li>
                            <li><a href="/services" class="hover-style-link">Commercial Pickup</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                        <h6 class="footer-widget__title mb-20">Quick links</h6>
                        <ul class="footer-widget__list">
                            <li><a href="/locations" class="hover-style-link">Locations</a></li>
                            <li><a href="/about-us" class="hover-style-link">About Us</a></li>
                            <li><a href="/quote" class="hover-style-link">Request Quote</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                        ...
                        <ul class="footer-widget__list">
                            ...
                            <li><a href="/pricing" class="hover-style-link">Pricing and plans</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                        <div class="footer-widget__title section-space--mb_50"></div>
                        <ul class="footer-widget__list">
                            <li><a href="#" class="image_btn"><img class="img-fluid" src="/images/icons/aeroland-button-google-play.jpg" alt=""></a></li>
                            <li><a href="#" class="image_btn"><img class="img-fluid" src="/images/icons/aeroland-button-app-store.jpg" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-center text-md-left">
                        <span class="copyright-text">&copy; {{ now()->year }} -  234 Waste Management. <a href="https://234wm.com.ng/">All Rights Reserved.</a></span>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-8">
                            ...
                            <div class="logo">
                                <a href="index.html">
                                    <img src="/images/logo/logo-dark.png" class="img-fluid" alt="">
                                </a>
                            </div>
                        </div>
