...
<div class="preloader-activate preloader-active open_tm_preloader">
    <div class="preloader-area-wrap">
        <div class="spinner d-flex justify-content-center align-items-center h-100">
            ...
            <div class="bounce2 bg-yellow"></div>
                            ...
                            <div class="swiper-container header-top-info-slider-werap top-info-slider__container">
                                <div class="swiper-wrapper header-top-info-inner default-color">
                                    <div class="swiper-slide">
                                        <div class="info-item">
                                            <div class="info-icon ">
                                                <span class="fa fa-phone txt-yellow"></span>
                                            </div>
                                            <div class="info-content">
                                                <h6 class="info-title">+234-81650000</h6>
                                                <div class="info-sub-title">Info@234wm.com.ng</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="info-item">
                                            <div class="info-icon">
                                                <span class="fa fa-map-marker-alt txt-yellow"></span>
                                            </div>
                                            <div class="info-content">
                                                <h6 class="info-title">Along Naf Conference center</h6>
                                                <div class="info-sub-title">Jahi Abuja, Nigeria</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="info-item">
                                            <div class="info-icon">
                                                <span class="fa fa-clock txt-yellow"></span>
                                            </div>
                                            <div class="info-content">
