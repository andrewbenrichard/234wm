...
<div class="site-wrapper-reveal">
    ...
    <div class="appointment-hero-wrapper appointment-hero-bg section-space--ptb_30">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="appointment-hero-wrap wow move-up">
                        <div class="appointment-hero-text">
                            <h1 class="font-weight--reguler text-white mb-30">Schedule your trash pickup with
                                <span class="text-line">234 Waste Management</span></h1>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-wrap text-center section-space--mb_40">
                        <h3 class="heading">Services We Deliver<br> we provide <span class="text-color-primary"> innovative waste management solutions.</span></h3>
                    </div>
                </div>
            </div>
                                ...
                                <div class="ht-box-icon style-02 single-svg-icon-box">
                                    <div class="icon-box-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="text">It’s our job to provide your business with dependable waste removal services that are safe, sound and on time.
                                            </div>
                                ...
                                <div class="ht-box-icon style-02 single-svg-icon-box">
                                    ...
                                    <div class="icon-box-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="text">Regardless of your garbage needs, can provide a solution. From recurring pickups of recycling and trash to single-use dumpsters for larger projects
                                            </div>
                                            <div class="feature-btn">
                                ...
                                <div class="ht-box-icon style-02 single-svg-icon-box">
                                    ...
                                    <div class="icon-box-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="text">We provide subscription residential waste removal in wheeled 95-gallon carts that are convenient while keeping your neighborhood tidy.
                                            </div>
                                            <div class="feature-btn">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-8 col-lg-7">
                        <div class="cta-content md-text-center">
                            <h3 class="heading">Need to book an appointment with us? <span class="text-color-primary"> Contact us now</span></h3>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="cta-button-group--two text-center">
                            <a href="contact-us" class="btn btn--white btn-one"><span class="btn-icon mr-2"><i class="far fa-comment-alt-dots"></i></span> Let's talk</a>
                            <a href="about-us" class="btn btn--secondary btn-two bg-yellow text-dark"><span class="btn-icon mr-2 "><i class="far fa-info-circle"></i></span> Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-wrap text-center section-space--mb_40">
                            ...
                            <h3 class="heading">What do people say about <span class="text-color-primary"> 234 Waste Management?</span></h3>
                        </div>
                                            ...
                                            <div class="testimonial-slider--info">
                                                ...
                                                <div class="testimonial-slider__author">
                                                    ...
                                                    <div class="author-info">
                                                        <h6 class="name">Ade John</h6>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="testimonial-slider__text">234 Waste management has been really helpful when it comes to picking up the waste at my apartment, would recommended them always.</div>
                                        ...
                                        <div class="testimonial-slider__one wow move-up">
                                            ...
                                            <div class="testimonial-slider--info">
                                                ...
                                                <div class="testimonial-slider__author">
                                                    ...
                                                    <div class="author-info">
                                                        <h6 class="name">Terwasa Adams</h6>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="testimonial-slider__text">Joined 234 Last month, I have no complaint about their services, they are always on time and never miss a pickup</div>
                                        ...
                                        <div class="testimonial-slider__one wow move-up">
                                            ...
                                            <div class="testimonial-slider--info">
                                                ...
                                                <div class="testimonial-slider__author">
                                                    ...
                                                    <div class="author-info">
                                                        <h6 class="name">Nathan Williams</h6>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="testimonial-slider__text">Ever since we subscribed to the yearly plan we've never had a issue with waste pickup at the office</div>
